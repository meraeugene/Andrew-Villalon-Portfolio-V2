import { curve, hero, heroBackground } from "../assets";
      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto  mb-6 md:mb-10  text-n-2 ">
            ...
            showcasing my expertise in NextJS, Supabase, Mongoose, Express,
            React, Node and TypeScript. With a focus on visually stunning and
            user-friendly websites, I strive to deliver seamless online

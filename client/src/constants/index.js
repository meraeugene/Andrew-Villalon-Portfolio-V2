...
export const projects = [
  ...
  // },
  {
    id: "71",
    title: "TwoGether",
    text: "Twogether is a web application social movie. Stream and recommend movies with friends. Twogether is your cozy social movie space to discover what couples and friends are watching together.",
    date: "July 2025",
    status: "done",
    imageUrl: twogether,
    colorful: true,
